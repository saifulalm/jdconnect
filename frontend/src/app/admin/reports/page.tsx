      ...
      <header className="sticky top-0 z-40 glass border-b border-border/60">
        <div className="container mx-auto px-4 h-16 flex items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold leading-tight">Laporan</h1>
              <p className="text-xs text-muted-foreground">Laporan penjualan</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <Card className="glass border-border/60 rounded-2xl overflow-hidden">
          ...
          <CardContent className="text-sm text-muted-foreground leading-relaxed">
            Halaman laporan belum terhubung ke endpoint backend. Navigasi tetap tersedia agar tidak 404.
          </CardContent>
        </Card>
      </main>
    </div>
